...
def recon_ops(source_det_distance=1085.6, source_distance=595.0, image_size=512, pixel_spacing=1.4285,
              angles=np.linspace(0, 2*np.pi, 576, endpoint=False), det_count=736, det_spacing=1.2858):
