...
root_dir = '/mnt/no4/yikun/CLEAR/Data'
case_list = os.listdir(root_dir + '/AAPM/')

for index, case in enumerate(case_list):

    hdproj_save_path = root_dir + '/sAAPMProj/' + case + '/clean_proj/'
    ldproj_save_path = root_dir + '/sAAPMProj/' + case + '/noisy_proj_5e4/'
    ldct_save_path = root_dir + '/sAAPMCT/' + case + '/noisy_CT_5e4/'
    ...
    for slice in range(np.size(hdct_vol, 0)):
        ...
        with torch.no_grad():
            ...
            ldproj_slice = addPossionNoisy(hdproj_slice, 5e4)
