...
#     v, u = np.shape(CleanProj)

#     TempProj = I0 * np.exp(-CleanProj)
#     NoiseProj = np.random.poisson(TempProj, [v, u]) + 1
...
# def addPossionGaussianNoisy(projections, Gaussian=None, Poisson=None):
#
...
class plotImg3D:  # noqa: N801
    ...
    #    Dim can be 'X','Y','Z'
    #    X for the first dim and z for the last dim.
